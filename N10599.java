...
public class N10599 {
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            ...
            int minBirth = Integer.parseInt(stoi.nextToken());
            int maxBirth = Integer.parseInt(stoi.nextToken());
            int minDeath = Integer.parseInt(stoi.nextToken());
            int maxDeath = Integer.parseInt(stoi.nextToken());

            if(minBirth == 0 && maxBirth == 0 && minDeath == 0 && maxDeath == 0) {
                break;
            }

            build.append((minDeath - maxBirth) + " ");
            build.append((maxDeath - minBirth) + "\n");
        }
