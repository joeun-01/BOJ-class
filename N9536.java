...
public class N9536 {
    public static void main(String[] args) throws IOException {
        ...
        while(T > 0) {
            StringTokenizer roars = new StringTokenizer(read.readLine());

            while(true) {
                String animal = read.readLine();

                if(animal.equals("what does the fox say?")) break;

                StringTokenizer animals = new StringTokenizer(animal);
                animals.nextToken();
                animals.nextToken();
            ...
            while(roars.hasMoreTokens()) {
                ...
                if(!set.contains(roar)) build.append(roar).append(" ");
            }
