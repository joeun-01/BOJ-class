...
/*
수학을 못해도 너무 못하는 상근이는 정인이에게 과외를 받고 있다. 
...
첫째 줄에 정인이가 적어준 세 정수가 주어진다. 
이 수는 100보다 작거나 같은 자연수이다. 
...
public class N2985 {
    public static void main(String[] args) throws IOException {
        ...
        else if((B % C == 0) && (B / C == A)) System.out.println(A + "=" + B + "/" + C);
        else if(A + B == C) System.out.println(A + "+" + B + "=" + C);
        else if(A - B == C) System.out.println(A + "-" + B + "=" + C);
        else if(A * B == C) System.out.println(A + "*" + B + "=" + C);
        else if((A % B == 0) && (A / B == C)) System.out.println(A + "/" + B + "=" + C);
