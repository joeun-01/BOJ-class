...
public class N5464 {
    public static void main(String[] args) throws IOException {
        ...
        int[] parkingFee = new int[N];
        for(int i = 0; i < N; i++) {
            parkingFee[i] = Integer.parseInt(read.readLine());
        }

        TreeMap<Integer, Integer> map = new TreeMap<>();
        for(int i = 1; i <= M; i++) {
            map.put(i, Integer.parseInt(read.readLine()));
        }
