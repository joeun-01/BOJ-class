...
public class N1350 {
    public static void main(String[] args) throws IOException {
        ...
        int cluster = Integer.parseInt(read.readLine());
        
        for(int i = 0; i < N; i++) {
            int file = Integer.parseInt(stoi.nextToken());
            
            if(file % cluster == 0) sum += file / cluster;
            else sum += (file / cluster + 1);
        }

        System.out.println(cluster * sum);
    }
}
