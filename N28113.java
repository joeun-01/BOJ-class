...
public class N28113 {
    public static void main(String[] args) throws IOException {
        ...
        long N = Integer.parseInt(stoi.nextToken());  // 지하철까지 가는 시간
        long bus = Integer.parseInt(stoi.nextToken());  // 버스 도착 시간
        long subway = Integer.parseInt(stoi.nextToken());  // 지하철 도착 시간
        ...
        if(subway == bus) System.out.println("Anything");
        else if(subway < bus) System.out.println("Subway");
