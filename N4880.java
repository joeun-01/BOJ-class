...
각 테스트 케이스는 수열의 연속하는 세 정수 a1, a2, a3이 한 줄에 주어진다. (-10,000 < a1, a2, a3 < 10,000) 
a1, a2, a3은 서로 같지 않다.
...
public class N4880 {
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            StringTokenizer sequence = new StringTokenizer(read.readLine());
            int a = Integer.parseInt(sequence.nextToken());
            int b = Integer.parseInt(sequence.nextToken());
            int c = Integer.parseInt(sequence.nextToken());
